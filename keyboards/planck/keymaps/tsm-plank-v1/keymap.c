...
const uint16_t PROGMEM lgui_space_combo[] = {MO(_RAISE), MO(_NUMPAD), COMBO_END};
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LGUI,    HOLD, MO(_LOWER), KC_LCTRL, KC_LALT, MO(_RAISE), KC_SPC, MO(_NUMPAD), MO(_VIM_BINDS), KC_MUTE, KC_VOLD, KC_VOLU
),
